...
class Admin extends CI_Controller
{
  ...
  function student_profile($student_id)
  {
	...
	function student_information($class_id = '')
	{
		...
		$page_data['page_title'] 	= get_phrase('Informasi'). " - ".get_phrase('kelas')." : ".
    ...
    function student_payment($param1 = '' , $param2 = '' , $param3 = '') {
        ...
        $page_data['page_title'] = get_phrase('membuat_kwitansi_spp_siswa');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function question_paper($param1 = "", $param2 = "")
    {
        ...
        $data['page_title'] = get_phrase('lembar_pertanyaan');
...
//                    $data2['roll']        = $row[1];
    ...
    function online_exam_questions_print_view($online_exam_id, $answers) {
        ...
        $page_data['page_title'] = get_phrase('cetak_lembar_pertanyaan');
